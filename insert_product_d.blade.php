...
<body>
<!-- if the user is not authorized it should not allow you enter this page -->
@if(!Auth::check())
    ...
    $('#form_d').submit(function(e){
      ...
      $.ajax({
            ...
            success:function(data)
              {
                  $("#alert").html(data.name_product+"<br>"+data.price_product+"<br>"+data.about_product+"<br>"+data.img_product);
              }
